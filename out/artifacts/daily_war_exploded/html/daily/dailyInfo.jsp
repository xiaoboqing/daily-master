...
<div class="layui-card">
    ...
    <div class="modal fade" id="proUpdateModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabelUpdate">
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="z-index: 19896; width: 700px; height: 600px; top: -24px; left: -107px;">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
                    </button>
                    ...
                    <form class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group" id="idea" >
                                <label class="layui-form-label" style="width: 100px">意见</label>
                                <div class="col-sm-7">
                                    <input type="text" name="remark1" id="idea_update_input" class="form-control" style="width: 517px">
                                </div>
                            </div>
                    </form>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
                    <button type="button" class="btn btn-primary" id="daily_update_btn">修改</button>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/html" id="toolbar">
    ...
    <span class="layui-btn layui-btn-xs" id="updates" lay-event="update">详情</span>
...
<script>
    ...
    console.log(".........."+userRoleList.indexOf(5))
    console.log(".........."+userRoleList.indexOf(7))
    if (userRoleList.indexOf(5) != -1 || userRoleList.indexOf(7) != -1) {
    }else {
        document.getElementById("idea_update_input").setAttribute("readOnly",true);
    }
    ...
    function getDailyDetailInfo(id) {
        $.ajax({
            ...
            success: function (result) {
                ...
                $("#idea_update_input").val(proData.remark1);
            }
        });
    };

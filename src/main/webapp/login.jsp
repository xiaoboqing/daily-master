    ...
    <div class="top2-1">
        ...
        <div class="top2-2">
            ...
            <div class="layui-input2">
                <input type="text" id="email" name="title" onblur="checkEmail()" lay-verify="title" autocomplete="off"  value="001@qq.com" required placeholder="请输入邮箱" class="layui-input">
            </div>
            <div class="top2-5"></div>
            <div class="layui-input2">
                <input type="password" id="password" name="password" lay-verify="title" autocomplete="off" value="wlz123321" required placeholder="请输入密码" class="layui-input">
            </div>
            ...
            <div class="top2-8"></div>
        </div>
    </div>
</section>
<section class="top3">
    <div class="top3-1">
        <div class="top3-2">日报管理系统</div>
        <a href="http://www.ztbu.edu.cn/"><div class="top3-3">zhengzhougongshangxueyuan Ⓒ 2020 </div></a>
    </div>
</section>
</body>
